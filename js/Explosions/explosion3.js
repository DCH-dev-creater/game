export default class Explosion3 {
    ...
    render() {
        this.app.ctx.drawImage(this.image, this.frameSizeX * this.Xindex, this.frameSizeY * this.Yindex, this.frameSizeX, this.frameSizeY, this.position.x, this.position.y, this.frameCanvasSizeX, this.frameCanvasSizeY)
    }
}